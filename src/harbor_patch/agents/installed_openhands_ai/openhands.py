...
class OpenHands(BaseInstalledAgent):
    ...
    def populate_context_post_run(self, context: AgentContext) -> None:
        ...
        context.metadata["harbor_agent_tool_call"] = timing_metrics["harbor_agent_tool_call"]
    ...
    async def install(self, environment: BaseEnvironment) -> None:
        await self.exec_as_root(
            environment,
            command="sed -i 's/archive.ubuntu.com/mirrors.tuna.tsinghua.edu.cn/g' /etc/apt/sources.list && apt-get update && apt-get install -y curl git build-essential tmux",
        ...
        if self._git_version:
            ...
            install_cmd = f"uv pip install openhands-ai[all]=={self._version} deprecated six"
        else:
